              ...
              <CardDescription>
                {product.nickname == 'Unlimited'
                  ...
                  : product.nickname == 'Free' &&
                    "Get a monthly wave of credits to automate your tasks with ease. Perfect for starters looking to dip their toes into FlowState's automation capabilities."}
              </CardDescription>
              <div className="flex justify-between">
                ...
                <p className="font-bold">
                  {product.nickname == 'Free'
                    ...
                    : product.nickname == 'Pro'
                    ? '4.99'
                    : product.nickname == 'Unlimited' && '9.99'}
                  /mo
                </p>
              </div>
